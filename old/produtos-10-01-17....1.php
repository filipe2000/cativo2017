...
<script>
 $( document ).ready(function() { 
  ...
  function carregar(pagina){
    ...
    $(document).ready(function()
    {
    $(".lb-outerContainer").css("height",$(window).height());
  	});				
 	$(document).ready(function()
 		{
 			$(".lb-image").removeAttr("style");
 			$(".lb-image").css("background-color","#000");
 		});
...
<div>
	<div  >	
		<div class="prod-filter">
			...
			<i class="fa fa-home fa-lg homeProd" onclick="carregar('produtos/init.php')" alt="Inicio" title="Inicio"></i>								
			<li>				
				<a href="#produtos" onclick="carregar('produtos/filtros/filtros.html')" class="filter" >Filtros-</a>
			</li>
			<li>
				<a href="#produtos" onclick="carregar('produtos/oleos/oleos.html')" class="filter" >Óleos-</a>
			</li>
			<li>
				<a href="#produtos" onclick="carregar('produtos/bombas/bombas.html')" class="filter">Bombas-</a>
			</li>
			<li>
				<a href="#produtos" onclick="carregar('produtos/cabos/cabos.html')" class="filter">Cabos-</a>
			</li>
			<li>
				<a href="#produtos" onclick="carregar('produtos/amortecedor/amortecedor.html')" class="filter">Amortecedor</a>
			</li> 
			<a href="catalogo.php" target="_self">
