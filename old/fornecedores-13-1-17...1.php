...
<script>
	...
	{
		var avanc="Descrição Avanco";
		var bard="Descrição bardahl";
		var castr="Descrição Castrol";
		var cobr="Descrição Cobreq";
		var ga="Descrição Gauss";
		var jho="Descrição Johnson";
		var ml="Descrição Metal Leve";
		var rad1="Descrição Radiex";
		var rad2="Descrição Radnaq";
		var w="Descrição Wega";
