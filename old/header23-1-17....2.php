...
<div class="container" > 
    <div class="row subR">
        ...
        <a href="#" onclick="bgAnimate();">0</a>---
        <a href="#" onclick="changeBackGround('img/bg_clouds2.png');">1</a>---
        <a href="#" onclick="changeBackGround('img/vaio_hard_edge.png');">2</a>---      
        <a href="#" onclick="changeBackGround('img/new_year_background.png');">3</a>---
        <a href="#" onclick="changeBackGround('img/small_steps.png');">4</a>---
        <a href="#" onclick="changeBackGround('img/nistri.png');">5</a> ---
        <a href="#" onclick="changeBackGround('img/hexellence.png');">6</a>
        </div><!-- div col -->
    </div><!--row -->         
</div>
</header>               
