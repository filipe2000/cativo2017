...
/* array produtos
 $array_prod= array(
 array("cod"=>"0302CP","descr"=>"Lona Freio Moto","image"=>"0302CP.jpg","categoria"=>"lona"),
 array("cod"=>"0321CP","descr"=>"Lona Freio Moto Dafra","image"=>"0321CP.jpg","categoria"=>"lona"),
 array("cod"=>"FCD0771","descr"=>"Filtro Comb. Ducato / Jumper","image"=>"FCD0771.jpg","categoria"=>"filtro"),
 array("cod"=>"0337","descr"=>"SELANTE PRETO ALTA TEMPERATURA 50G","image"=>"0337.jpg","categoria"=>"limpeza"),
 array("cod"=>"1453","descr"=>"SELANTE LIQUIDO SEMI SECATIVO 1304 100GR","image"=>"1453.jpg","categoria"=>"limpeza"),
    ...
    <img class="img-responsive" src="img/mais.jpg ">           
        <div class="overlay">
            <div class="recent-work-inner"> 
                ...
                <a class="preview" href="catalogo.php">Catálogo</a></h3>
            </div> 
        </div>
