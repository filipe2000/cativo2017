...
<div class="row" style="padding-top:20px;" >
	...
	<div class="col-md-5 " >
		...
		<div class="row subR">
				<div class="col-md-12 col-sm-12 col-xs-12 text-justify" >
					Os recordes mundiais são ganhos - não dados. O 1966 Volvo P1800S, de propriedade de Irv Gordon ganhou seu lugar na história de resistência. Com mais de 3 milhões de quilômetros percorridos, 
					ele detém firmemente o recorde 
					<span class="pre-spoiler">
			<input id="xs" value="+" onclick="
				if (this.parentNode.parentNode.getElementsByTagName('span')[1].getElementsByTagName('span')[0].style.display != '') { 
					this.parentNode.parentNode.getElementsByTagName('span')[1].getElementsByTagName('span')[0].style.display = '';
			...
			<span><!-- texto a exibir-->
			<span class="spoiler" style="display: none;">
					de mais milhas registradas em um carro de passageiros de propriedade original. Um recorde mundial que nunca pode ser quebrado.
					Desde o dia em que Irv rolou seu Volvo para fora do showroom, a Castrol / GTX foi seu óleo de escolha. Na verdade, é o único óleo que ele já usou. Para entender o que permitiu este recorde mundial, consultámos um especialista em motores Volvo e fomos debaixo do capô para dar uma olhada mais de perto em 3 peças críticas do motor. Essas peças registraram mais milhas do que qualquer outra peça de motor atualmente registrada.
					</span>
					</span> 
				</div>
			</div>
	...
	<div class="col-md-7 " ><!--col 5 principal-->
		...
		<div class="row subR">							
			...
			<div class="col-md-9 col-sm-6 col-xs-6 evDesc">
		...
		<div class="row subR">							
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="img/Renault.jpg" class="imgC">
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12 text-justify"><br>
			Renault e Castrol retomam parceria campeã da Fórmula-1 em 1997.
			Anunciaram a parceria estratégica que marca o regresso da petrolífera a esta modalidade para se juntar à recém-formada equipa de Fórmula 1 da Renault e apoiá-la na sua ambição de lutar pelo Campeonato Mundial da modalidade nos 
			<span class="pre-spoiler">
			<input id="xs" value="+" onclick="
				if (this.parentNode.parentNode.getElementsByTagName('span')[1].getElementsByTagName('span')[0].style.display != '') { 
					this.parentNode.parentNode.getElementsByTagName('span')[1].getElementsByTagName('span')[0].style.display = '';
			...
			<span class="spoiler" style="display: none;">
			próximos cinco anos.
			Com os novos regulamentos sobre aerodinâmica para a época de 2017 da Fórmula 1, a importância da energia vai aumentar. Portanto, os combustíveis e os lubrificantes vão fazer uma diferença ainda maior no desempenho global do carro.
			</span>
			</span>
			</div>
		</div>
